...
public class LevelFour implements LevelInformation {
     ...
     */
    public LevelFour(GameFlow gameLevel) {
        ...
        for (int rowIndex = 0; rowIndex < 5; ++rowIndex) {
            ...
            for (int colIndex = 0; colIndex < 19; ++colIndex) {
                blocks.add(new Block(new Rectangle(new Point(blockWidth * colIndex + 20,
                                                100 + blockHeight * rowIndex),
                                                   blockWidth,
                                                   blockHeight), color));
            }
        }
        this.background = new LevelFourBackground(gameLevel);
    }
